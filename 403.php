...
<html lang="en">
  ...
  <!-- third-generation iPad with high-resolution Retina display: -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/imagens/404-icon.svg">
        <!-- iPhone with high-resolution Retina display: -->
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/imagens/404-icon.svg">
        <!-- first- and second-generation iPad: -->
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/imagens/404-icon.svg">
        <!-- non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
        <link rel="apple-touch-icon-precomposed" href="assets/imagens/404-icon.svg">
        <!-- basic favicon -->
        <link rel="shortcut icon" href="assets/imagens/404-icon.svg">
  <style>
* {
  margin:0;
  padding: 0;
...
<h1>403</h1>
<h2>Espere um pouco, seu acesso foi negado!<br>
<a href="/">Voltar</a></h2>
</body>
</html>
