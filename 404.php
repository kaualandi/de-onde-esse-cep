...
<html lang="en">
  ...
  <!-- third-generation iPad with high-resolution Retina display: -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/images/icons/404-icon.svg">
        <!-- iPhone with high-resolution Retina display: -->
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/icons/404-icon.svg">
        <!-- first- and second-generation iPad: -->
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/images/icons/404-icon.svg">
        <!-- non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
        <link rel="apple-touch-icon-precomposed" href="assets/images/icons/404-icon.svg">
        <!-- basic favicon -->
        <link rel="shortcut icon" href="assets/images/icons/404-icon.svg">
  <style>
* {
  margin:0;
  padding: 0;
...
<h1>404</h1>
<h2>Talvez essa página tenha sido movida? Foi excluída? Está se escondendo em quarentena? Nunca existiu em primeiro lugar?<br>Vamos recomeçar! Voltar ao <a href="/">início</a> ou <a href="https://api.whatsapp.com/send?phone=5521999222644&text=Ol%C3%A1%2C%20vim%20relatar%20um%20erro!">entrar em contato</a>.</h2>
</body>
</html>
